...
const (
	...
	SpeciesServiceName = "tkd.treatment.v1.SpeciesService"
)
...
const (
	...
	// CreateSpecies RPC.
	SpeciesServiceCreateSpeciesProcedure = "/tkd.treatment.v1.SpeciesService/CreateSpecies"
	// SpeciesServiceListSpeciesProcedure is the fully-qualified name of the SpeciesService's
	// ListSpecies RPC.
	SpeciesServiceListSpeciesProcedure = "/tkd.treatment.v1.SpeciesService/ListSpecies"
	// SpeciesServiceUpdateSpeciesProcedure is the fully-qualified name of the SpeciesService's
	// UpdateSpecies RPC.
	SpeciesServiceUpdateSpeciesProcedure = "/tkd.treatment.v1.SpeciesService/UpdateSpecies"
	// SpeciesServiceDeleteSpeciesProcedure is the fully-qualified name of the SpeciesService's
	// DeleteSpecies RPC.
	SpeciesServiceDeleteSpeciesProcedure = "/tkd.treatment.v1.SpeciesService/DeleteSpecies"
	// SpeciesServiceDetectSpeciesProcedure is the fully-qualified name of the SpeciesService's
	// DetectSpecies RPC.
	SpeciesServiceDetectSpeciesProcedure = "/tkd.treatment.v1.SpeciesService/DetectSpecies"
)

// SpeciesServiceClient is a client for the tkd.treatment.v1.SpeciesService service.
type SpeciesServiceClient interface {
	...
	DetectSpecies(context.Context, *connect_go.Request[v1.DetectSpeciesRequest]) (*connect_go.Response[v1.ListSpeciesResponse], error)
}

// NewSpeciesServiceClient constructs a client for the tkd.treatment.v1.SpeciesService service. By
...
func NewSpeciesServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) SpeciesServiceClient {
	...
	return &speciesServiceClient{
		...
		detectSpecies: connect_go.NewClient[v1.DetectSpeciesRequest, v1.ListSpeciesResponse](
			httpClient,
			baseURL+SpeciesServiceDetectSpeciesProcedure,
			opts...,
		),
	}
}
...
type speciesServiceClient struct {
	...
	detectSpecies *connect_go.Client[v1.DetectSpeciesRequest, v1.ListSpeciesResponse]
}

// CreateSpecies calls tkd.treatment.v1.SpeciesService.CreateSpecies.
...
// ListSpecies calls tkd.treatment.v1.SpeciesService.ListSpecies.
...
// UpdateSpecies calls tkd.treatment.v1.SpeciesService.UpdateSpecies.
...
// DeleteSpecies calls tkd.treatment.v1.SpeciesService.DeleteSpecies.
...
// DetectSpecies calls tkd.treatment.v1.SpeciesService.DetectSpecies.
func (c *speciesServiceClient) DetectSpecies(ctx context.Context, req *connect_go.Request[v1.DetectSpeciesRequest]) (*connect_go.Response[v1.ListSpeciesResponse], error) {
	return c.detectSpecies.CallUnary(ctx, req)
}

// SpeciesServiceHandler is an implementation of the tkd.treatment.v1.SpeciesService service.
...
func NewSpeciesServiceHandler(svc SpeciesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	speciesServiceDetectSpeciesHandler := connect_go.NewUnaryHandler(
		SpeciesServiceDetectSpeciesProcedure,
		svc.DetectSpecies,
		opts...,
	)
	return "/tkd.treatment.v1.SpeciesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		...
		case SpeciesServiceDetectSpeciesProcedure:
			speciesServiceDetectSpeciesHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedSpeciesServiceHandler) CreateSpecies(context.Context, *connect_go.Request[v1.Species]) (*connect_go.Response[v1.Species], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.treatment.v1.SpeciesService.CreateSpecies is not implemented"))
}
...
func (UnimplementedSpeciesServiceHandler) ListSpecies(context.Context, *connect_go.Request[v1.ListSpeciesRequest]) (*connect_go.Response[v1.ListSpeciesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.treatment.v1.SpeciesService.ListSpecies is not implemented"))
}
...
func (UnimplementedSpeciesServiceHandler) UpdateSpecies(context.Context, *connect_go.Request[v1.UpdateSpeciesRequest]) (*connect_go.Response[v1.Species], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.treatment.v1.SpeciesService.UpdateSpecies is not implemented"))
}
...
func (UnimplementedSpeciesServiceHandler) DeleteSpecies(context.Context, *connect_go.Request[v1.DeleteSpeciesRequest]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.treatment.v1.SpeciesService.DeleteSpecies is not implemented"))
}

func (UnimplementedSpeciesServiceHandler) DetectSpecies(context.Context, *connect_go.Request[v1.DetectSpeciesRequest]) (*connect_go.Response[v1.ListSpeciesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.treatment.v1.SpeciesService.DetectSpecies is not implemented"))
}
