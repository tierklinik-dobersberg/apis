...
var file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd2, 0x01, 0x0a, 0x08, 0x49, 0x6e, 0x73,
	...
	0x49, 0x43, 0x4f, 0x4d, 0x54, 0x61, 0x67, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x3e, 0x0a,
	0x09, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61, 0x69, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x20, 0x2e, 0x74, 0x6b, 0x64, 0x2e, 0x6f, 0x72, 0x74, 0x68, 0x61, 0x6e, 0x63, 0x5f, 0x62,
	0x72, 0x69, 0x64, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61,
	0x69, 0x6c, 0x52, 0x09, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61, 0x69, 0x6c, 0x22, 0xcb, 0x01,
...
var file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_depIdxs = []int32{
	...
	3,  // 6: tkd.orthanc_bridge.v1.Instance.thumbnail:type_name -> tkd.orthanc_bridge.v1.Thumbnail
	4,  // 7: tkd.orthanc_bridge.v1.Series.instances:type_name -> tkd.orthanc_bridge.v1.Instance
	11, // 8: tkd.orthanc_bridge.v1.Series.time:type_name -> google.protobuf.Timestamp
	1,  // 9: tkd.orthanc_bridge.v1.Series.tags:type_name -> tkd.orthanc_bridge.v1.DICOMTag
	5,  // 10: tkd.orthanc_bridge.v1.Study.series:type_name -> tkd.orthanc_bridge.v1.Series
	11, // 11: tkd.orthanc_bridge.v1.Study.time:type_name -> google.protobuf.Timestamp
	1,  // 12: tkd.orthanc_bridge.v1.Study.tags:type_name -> tkd.orthanc_bridge.v1.DICOMTag
	6,  // 13: tkd.orthanc_bridge.v1.ListStudiesResponse.studies:type_name -> tkd.orthanc_bridge.v1.Study
	2,  // 14: tkd.orthanc_bridge.v1.OrthancBridge.ListStudies:input_type -> tkd.orthanc_bridge.v1.ListStudiesRequest
	7,  // 15: tkd.orthanc_bridge.v1.OrthancBridge.ListStudies:output_type -> tkd.orthanc_bridge.v1.ListStudiesResponse
