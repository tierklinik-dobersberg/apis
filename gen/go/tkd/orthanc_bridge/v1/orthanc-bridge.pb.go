...
type DeleteWorklistEntryRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DeleteWorklistEntryRequest) Reset() {
	*x = DeleteWorklistEntryRequest{}
	mi := &file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteWorklistEntryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteWorklistEntryRequest) ProtoMessage() {}

func (x *DeleteWorklistEntryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteWorklistEntryRequest.ProtoReflect.Descriptor instead.
func (*DeleteWorklistEntryRequest) Descriptor() ([]byte, []int) {
	return file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_rawDescGZIP(), []int{15}
}

func (x *DeleteWorklistEntryRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type CreateWorklistEntryRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	OwnerId         string                 `protobuf:"bytes,1,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty"`
	PatientId       string                 `protobuf:"bytes,2,opt,name=patient_id,json=patientId,proto3" json:"patient_id,omitempty"`
	ScheduledAet    string                 `protobuf:"bytes,3,opt,name=scheduled_aet,json=scheduledAet,proto3" json:"scheduled_aet,omitempty"`
...
func (x *CreateWorklistEntryRequest) Reset() {
	*x = CreateWorklistEntryRequest{}
	mi := &file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateWorklistEntryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateWorklistEntryRequest) ProtoMessage() {}

func (x *CreateWorklistEntryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateWorklistEntryRequest.ProtoReflect.Descriptor instead.
func (*CreateWorklistEntryRequest) Descriptor() ([]byte, []int) {
	return file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_rawDescGZIP(), []int{16}
}

func (x *CreateWorklistEntryRequest) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *CreateWorklistEntryRequest) GetPatientId() string {
	if x != nil {
		return x.PatientId
	}
	return ""
...
func (x *CreateWorklistEntryRequest) GetScheduledAet() string {
	if x != nil {
		return x.ScheduledAet
	}
	return ""
}

func (x *CreateWorklistEntryRequest) GetStepDescription() string {
	if x != nil {
...
const file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_rawDesc = "" +
	...
	"\aentries\x18\x01 \x03(\v2$.tkd.orthanc_bridge.v1.WorklistEntryR\aentries\"9\n" +
	"\x1aDeleteWorklistEntryRequest\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfa\xf7\x18\x03\xc8\x01\x01R\x04name\"\xc1\x01\n" +
	"\x1aCreateWorklistEntryRequest\x12\"\n" +
	"\bowner_id\x18\x01 \x01(\tB\a\xfa\xf7\x18\x03\xc8\x01\x01R\aownerId\x12&\n" +
	"\n" +
	"patient_id\x18\x02 \x01(\tB\a\xfa\xf7\x18\x03\xc8\x01\x01R\tpatientId\x12,\n" +
	"\rscheduled_aet\x18\x03 \x01(\tB\a\xfa\xf7\x18\x03\xc8\x01\x01R\fscheduledAet\x12)\n" +
	"\x10step_description\x18\x04 \x01(\tR\x0fstepDescription*T\n" +
	...
	"\x12GetWorklistEntries\x120.tkd.orthanc_bridge.v1.GetWorklistEntriesRequest\x1a1.tkd.orthanc_bridge.v1.GetWorklistEntriesResponse\"\x05\xb2~\x02\b\x01\x12g\n" +
	"\x13DeleteWorklistEntry\x121.tkd.orthanc_bridge.v1.DeleteWorklistEntryRequest\x1a\x16.google.protobuf.Empty\"\x05\xb2~\x02\b\x01\x12u\n" +
	"\x13CreateWorklistEntry\x121.tkd.orthanc_bridge.v1.CreateWorklistEntryRequest\x1a$.tkd.orthanc_bridge.v1.WorklistEntry\"\x05\xb2~\x02\b\x01B\xf6\x01\n" +
...
var file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_goTypes = []any{
	...
	(*DeleteWorklistEntryRequest)(nil), // 16: tkd.orthanc_bridge.v1.DeleteWorklistEntryRequest
	(*CreateWorklistEntryRequest)(nil), // 17: tkd.orthanc_bridge.v1.CreateWorklistEntryRequest
	(*structpb.Value)(nil),             // 18: google.protobuf.Value
	(*v1.Element)(nil),                 // 19: tkd.dicom.v1.Element
	(*v11.DateRange)(nil),              // 20: tkd.common.v1.DateRange
	(*v11.Pagination)(nil),             // 21: tkd.common.v1.Pagination
	(*timestamppb.Timestamp)(nil),      // 22: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),        // 23: google.protobuf.Duration
	(*emptypb.Empty)(nil),              // 24: google.protobuf.Empty
}
var file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_depIdxs = []int32{
	18, // 0: tkd.orthanc_bridge.v1.DICOMTag.value:type_name -> google.protobuf.Value
	19, // 1: tkd.orthanc_bridge.v1.WorklistEntry.elements:type_name -> tkd.dicom.v1.Element
	20, // 2: tkd.orthanc_bridge.v1.ListStudiesRequest.date_range:type_name -> tkd.common.v1.DateRange
	3,  // 3: tkd.orthanc_bridge.v1.ListStudiesRequest.filter_tags:type_name -> tkd.orthanc_bridge.v1.FilterTag
	21, // 4: tkd.orthanc_bridge.v1.ListStudiesRequest.pagination:type_name -> tkd.common.v1.Pagination
	22, // 5: tkd.orthanc_bridge.v1.Instance.time:type_name -> google.protobuf.Timestamp
	...
	22, // 9: tkd.orthanc_bridge.v1.Series.time:type_name -> google.protobuf.Timestamp
	...
	22, // 12: tkd.orthanc_bridge.v1.Study.time:type_name -> google.protobuf.Timestamp
	...
	23, // 16: tkd.orthanc_bridge.v1.DownloadStudyRequest.time_to_live:type_name -> google.protobuf.Duration
	22, // 17: tkd.orthanc_bridge.v1.DownloadStudyResponse.expire_time:type_name -> google.protobuf.Timestamp
	23, // 18: tkd.orthanc_bridge.v1.ShareStudyRequest.valid_duration:type_name -> google.protobuf.Duration
	...
	24, // 21: tkd.orthanc_bridge.v1.OrthancBridge.ListRecentStudies:input_type -> google.protobuf.Empty
	...
	16, // 25: tkd.orthanc_bridge.v1.OrthancBridge.DeleteWorklistEntry:input_type -> tkd.orthanc_bridge.v1.DeleteWorklistEntryRequest
	17, // 26: tkd.orthanc_bridge.v1.OrthancBridge.CreateWorklistEntry:input_type -> tkd.orthanc_bridge.v1.CreateWorklistEntryRequest
	9,  // 27: tkd.orthanc_bridge.v1.OrthancBridge.ListStudies:output_type -> tkd.orthanc_bridge.v1.ListStudiesResponse
	9,  // 28: tkd.orthanc_bridge.v1.OrthancBridge.ListRecentStudies:output_type -> tkd.orthanc_bridge.v1.ListStudiesResponse
	11, // 29: tkd.orthanc_bridge.v1.OrthancBridge.DownloadStudy:output_type -> tkd.orthanc_bridge.v1.DownloadStudyResponse
	13, // 30: tkd.orthanc_bridge.v1.OrthancBridge.ShareStudy:output_type -> tkd.orthanc_bridge.v1.ShareStudyResponse
	15, // 31: tkd.orthanc_bridge.v1.OrthancBridge.GetWorklistEntries:output_type -> tkd.orthanc_bridge.v1.GetWorklistEntriesResponse
	24, // 32: tkd.orthanc_bridge.v1.OrthancBridge.DeleteWorklistEntry:output_type -> google.protobuf.Empty
	2,  // 33: tkd.orthanc_bridge.v1.OrthancBridge.CreateWorklistEntry:output_type -> tkd.orthanc_bridge.v1.WorklistEntry
