...
func file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_tkd_orthanc_bridge_v1_orthanc_bridge_proto_msgTypes[5].Exporter = func(v any, i int) any {
