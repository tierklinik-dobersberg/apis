...
func file_tkd_calendar_v1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tkd_calendar_v1_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tkd_calendar_v1_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tkd_calendar_v1_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
