...
func (x *CalendarEvent) GetCompleted() bool {
	if x != nil {
		return x.Completed
	}
	return false
...
const file_tkd_calendar_v1_event_proto_rawDesc = "" +
	...
	"\breadonly\x18\a \x01(\bR\breadonly\"\xf3\x03\n" +
	...
	"\fvirtual_copy\x18\f \x01(\bR\vvirtualCopy\x12\x1c\n" +
	"\tcompleted\x18\r \x01(\bR\tcompleted\"\xb0\x03\n" +
