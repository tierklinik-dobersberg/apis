...
const (
	...
	UserServiceName = "tkd.userd.v1.UserService"
)
...
const (
	...
	UserServiceGetUserProcedure = "/tkd.userd.v1.UserService/GetUser"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/tkd.userd.v1.UserService/ListUsers"
	// UserServiceCreateUserProcedure is the fully-qualified name of the UserService's CreateUser RPC.
	UserServiceCreateUserProcedure = "/tkd.userd.v1.UserService/CreateUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/tkd.userd.v1.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/tkd.userd.v1.UserService/DeleteUser"
)

// UserServiceClient is a client for the tkd.userd.v1.UserService service.
...
// NewUserServiceClient constructs a client for the tkd.userd.v1.UserService service. By default, it
...
// GetUser calls tkd.userd.v1.UserService.GetUser.
...
// ListUsers calls tkd.userd.v1.UserService.ListUsers.
...
// CreateUser calls tkd.userd.v1.UserService.CreateUser.
...
// UpdateUser calls tkd.userd.v1.UserService.UpdateUser.
...
// DeleteUser calls tkd.userd.v1.UserService.DeleteUser.
...
// UserServiceHandler is an implementation of the tkd.userd.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/tkd.userd.v1.UserService/", mux
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect_go.Request[v1.GetUserRequest]) (*connect_go.Response[v1.GetUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.userd.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect_go.Request[v1.ListUsersRequest]) (*connect_go.Response[v1.ListUsersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.userd.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect_go.Request[v1.CreateUserRequest]) (*connect_go.Response[v1.CreateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.userd.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect_go.Request[v1.UpdateUserRequest]) (*connect_go.Response[v1.UpdateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.userd.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect_go.Request[v1.DeleteUserRequest]) (*connect_go.Response[v1.DeleteUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("tkd.userd.v1.UserService.DeleteUser is not implemented"))
}
