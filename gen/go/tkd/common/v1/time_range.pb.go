...
var file_tkd_common_v1_time_range_proto_rawDesc = []byte{
...
var (
	...
	file_tkd_common_v1_time_range_proto_rawDescData = file_tkd_common_v1_time_range_proto_rawDesc
)

func file_tkd_common_v1_time_range_proto_rawDescGZIP() []byte {
	file_tkd_common_v1_time_range_proto_rawDescOnce.Do(func() {
		file_tkd_common_v1_time_range_proto_rawDescData = protoimpl.X.CompressGZIP(file_tkd_common_v1_time_range_proto_rawDescData)
	})
...
var file_tkd_common_v1_time_range_proto_goTypes = []interface{}{
...
func file_tkd_common_v1_time_range_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tkd_common_v1_time_range_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tkd_common_v1_time_range_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_tkd_common_v1_time_range_proto_rawDesc = nil
