...
const file_tkd_pbx3cx_v1_calllog_proto_rawDesc = "" +
	...
	"\x06status\x18\x0f \x01(\x0e2\x19.tkd.pbx3cx.v1.CallStatusR\x06status\"\x92\x01\n" +
	"\x06OnCall\x12-\n" +
	...
	"\x17CALL_STATUS_NOTANSWERED\x10\x042\xcd\r\n" +
	"\vCallService\x12M\n" +
	"\n" +
