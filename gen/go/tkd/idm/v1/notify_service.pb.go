...
func file_tkd_idm_v1_notify_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tkd_idm_v1_notify_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tkd_idm_v1_notify_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_tkd_idm_v1_notify_service_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*WebPushNotification_Binary)(nil),
		(*WebPushNotification_Notification)(nil),
	}
	file_tkd_idm_v1_notify_service_proto_msgTypes[6].OneofWrappers = []interface{}{
