...
proto3.util.setEnumType(AuthRequirement, "tkd.idm.v1.AuthRequirement", [
...
export class AuthDecorator extends Message<AuthDecorator> {
  /**
   * @generated from field: tkd.idm.v1.AuthRequirement require = 1;
   */
  ...
  static readonly typeName = "tkd.idm.v1.AuthDecorator";
