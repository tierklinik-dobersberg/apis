...
import type { BinaryReadOptions, Extension, FieldList, FieldMask, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, MessageOptions, MethodOptions, proto3, ServiceOptions } from "@bufbuild/protobuf";
 ...
 */
export declare const service_auth: Extension<ServiceOptions, ServiceAuthDecorator>;

/**
 * @generated from extension: tkd.common.v1.AuthDecorator auth = 2022;
 */
export declare const auth: Extension<MethodOptions, AuthDecorator>;

/**
 * @generated from extension: tkd.common.v1.PrivacyACL readable = 2026;
 */
export declare const readable: Extension<MessageOptions, PrivacyACL>;

/**
 * @generated from extension: tkd.common.v1.PrivacyACL self_service = 2027;
 */
export declare const self_service: Extension<MessageOptions, PrivacyACL>;
