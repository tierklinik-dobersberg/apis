...
export declare const WorkTimeService: {
  ...
  readonly methods: {
     ...
     */
    readonly updateWorkTime: {
      readonly name: "UpdateWorkTime",
      readonly I: typeof UpdateWorkTimeRequest,
      readonly O: typeof UpdateWorkTimeResponse,
      readonly kind: MethodKind.Unary,
    },
    /**
     ...
     */
    readonly deleteWorkTime: {
      readonly name: "DeleteWorkTime",
      readonly I: typeof DeleteWorkTimeRequest,
      readonly O: typeof DeleteWorkTimeResponse,
      readonly kind: MethodKind.Unary,
    },
  }
};
