...
export class ChangePasswordRequest extends Message<ChangePasswordRequest> {
  ...
  static readonly typeName = "tkd.userd.v1.ChangePasswordRequest";
...
export class ChangePasswordResponse extends Message<ChangePasswordResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tkd.userd.v1.ChangePasswordResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
export class UpdateProfileRequest extends Message<UpdateProfileRequest> {
  ...
  /**
   * @generated from field: repeated tkd.userd.v1.Address address = 4;
   */
  address: Address[] = [];

  /**
   * @generated from field: repeated tkd.userd.v1.EMail email = 5;
   */
  email: EMail[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tkd.userd.v1.UpdateProfileRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class UpdateProfileResponse extends Message<UpdateProfileResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tkd.userd.v1.UpdateProfileResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ValidateEmailRequest extends Message<ValidateEmailRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tkd.userd.v1.ValidateEmailRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
export class ValidateEmailResponse extends Message<ValidateEmailResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tkd.userd.v1.ValidateEmailResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
